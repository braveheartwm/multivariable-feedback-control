function [ret,x0,str,ts,xts]=colas_PItu1_nodelay(t,x,u,flag);
%COLAS_PITU1_NODELAY	is the M-file description of the SIMULINK system named COLAS_PITU1_NODELAY.
%	The block-diagram can be displayed by typing: COLAS_PITU1_NODELAY.
%
%	SYS=COLAS_PITU1_NODELAY(T,X,U,FLAG) returns depending on FLAG certain
%	system values given time point, T, current state vector, X,
%	and input vector, U.
%	FLAG is used to indicate the type of output to be returned in SYS.
%
%	Setting FLAG=1 causes COLAS_PITU1_NODELAY to return state derivatives, FLAG=2
%	discrete states, FLAG=3 system outputs and FLAG=4 next sample
%	time. For more information and other options see SFUNC.
%
%	Calling COLAS_PITU1_NODELAY with a FLAG of zero:
%	[SIZES]=COLAS_PITU1_NODELAY([],[],[],0),  returns a vector, SIZES, which
...
simver(1.3)
if (0 == (nargin + nargout))
     set_param(sys,'Location',[118,78,912,629])
     open_system(sys)
end;
...
add_line(sys,[440,135;570,135;570,385;470,385;470,390;440,390])
add_line(sys,[440,120;630,120;630,420;470,420;470,425;440,425])
