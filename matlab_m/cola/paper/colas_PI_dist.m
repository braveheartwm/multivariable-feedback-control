...
%	The block-diagram can be displayed by typing: COLAS_PI_DIST.
%
%	SYS=COLAS_PI_DIST(T,X,U,FLAG) returns depending on FLAG certain
%	system values given time point, T, current state vector, X,
%	and input vector, U.
%	FLAG is used to indicate the type of output to be returned in SYS.
%
%	Setting FLAG=1 causes COLAS_PI_DIST to return state derivatives, FLAG=2
%	discrete states, FLAG=3 system outputs and FLAG=4 next sample
%	time. For more information and other options see SFUNC.
%
%	Calling COLAS_PI_DIST with a FLAG of zero:
%	[SIZES]=COLAS_PI_DIST([],[],[],0),  returns a vector, SIZES, which
...
simver(1.3)
if (0 == (nargin + nargout))
     set_param(sys,'Location',[59,60,853,611])
     open_system(sys)
end;
...
add_block('built-in/To Workspace',[sys,'/','V'])
set_param([sys,'/','V'],...
		'mat-name','u2',...
		'buffer','1200',...
...
set_param([sys,'/',['From',13,'Workspace']],...
		'matl_expr','TV',...
		'position',[20,237,60,263])

add_block('built-in/From Workspace',[sys,'/',['From',13,'Workspace1']])
set_param([sys,'/',['From',13,'Workspace1']],...
		'matl_expr','TL',...
		'position',[20,102,60,128])

add_block('built-in/From Workspace',[sys,'/',['From',13,'Workspace2']])
set_param([sys,'/',['From',13,'Workspace2']],...
		'orientation',2,...
		'matl_expr','rxB',...
		'position',[670,385,710,415])

add_block('built-in/From Workspace',[sys,'/',['From',13,'Workspace3']])
set_param([sys,'/',['From',13,'Workspace3']],...
		'orientation',2,...
		'matl_expr','ryD',...
		'position',[670,445,710,475])

add_block('built-in/From Workspace',[sys,'/',['From',13,'Workspace4']])
set_param([sys,'/',['From',13,'Workspace4']],...
		'matl_expr','TF',...
		'position',[20,432,60,458])

add_block('built-in/From Workspace',[sys,'/',['From',13,'Workspace5']])
set_param([sys,'/',['From',13,'Workspace5']],...
		'matl_expr','TzF',...
		'position',[20,482,60,508])
...
add_line(sys,[665,460;560,460;560,435;440,435])
add_line(sys,[665,400;440,400])
add_line(sys,[440,120;460,120;460,75;680,75])
add_line(sys,[120,120;220,120])
add_line(sys,[65,115;90,115])
...
add_line(sys,[65,495;166,495;165,170;220,170])
add_line(sys,[65,445;156,445;155,160;220,160])
