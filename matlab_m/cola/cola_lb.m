function xprime=cola_lb(t,X) 
% sample usage:   [t,x]=ode15s('cola_lb',[0 5000],0.5*ones(1,82));
%
% cola_lb - Subroutine for simulation with LB-configuration.
%           It calls the model colamod, and 
%           includes control of condenser and reboiler level 
%           using two P-controllers with the LB-configuration. 
%
%            Inputs are reflux (LT) and bottoms flow (B). Disturbances
...
Ds=0.5; VBs=3.20629;     % Nominal flows
